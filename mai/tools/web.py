...
errors are allowed to propagate as explicit tool failures instead of being
converted into empty or success-shaped fallback results.
"""
...
class WebSearchInput(BaseModel):
    ...
    max_results: int = Field(
        ...
        ge=1,
        le=10,
        description="Maximum number of ranked web results to return",
    )


def web_search(query: str, max_results: int = 5) -> dict[str, object]:
    """Search the public web and return structured ranked results."""
