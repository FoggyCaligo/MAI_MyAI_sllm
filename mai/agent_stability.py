...
GROUNDING_REVIEW_INSTRUCTION = (
    ...
    "evidence IDs. Preserve exact structured values and units from the evidence; do not accept numerically different "
    "reformatted values unless the equivalence is explicit in the evidence. If evidence is insufficient, request more evidence instead of accepting."
)
